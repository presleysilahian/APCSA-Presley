...
public class MadLib
{
	...
	{
		try{
		    Scanner scan = new Scanner(new File("C:\\Users\\silahianp1916\\Desktop\\APCSA-Presley\\Unit 10\\src\\nouns.dat"));
		    while(scan.hasNext()){
			    nouns.add(scan.next());
	...
	{
		try{
		Scanner scan = new Scanner(new File("C:\\Users\\silahianp1916\\Desktop\\APCSA-Presley\\Unit 10\\src\\verbs.dat"));
		while(scan.hasNext()){
			verbs.add(scan.next());
		}
	...
	{
		try{
		Scanner scan = new Scanner(new File("C:\\Users\\silahianp1916\\Desktop\\APCSA-Presley\\Unit 10\\src\\adjectives.dat"));
		while(scan.hasNext()){
